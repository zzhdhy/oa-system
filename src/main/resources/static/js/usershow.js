...
$('.usershow').popover({
    ...
    template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
        ...
        + '<tr><td style="padding:4px">Tel:</td><td class="thistel" style="padding:4px">13619594490</td></tr>'
        + '<tr><td style="padding:4px">Email:</td><td class="thisemail" style="padding:4px">1460819552@qq.com</td></tr>'
        + '</table>	</div></div>'
});
...
$('.othershow').popover({
    ...
    template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
        ...
        + '<tr><td style="padding:4px">E-mail:</td><td class="thistel" style="padding:4px">13619594490</td></tr>'
        + '<tr><td style="padding:4px">Company:</td><td class="thisemail" style="padding:4px">1460819552@qq.com</td></tr>'
        + '</table>	</div></div>'
});
