                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div style="border-bottom: 1px solid #f4f4f4;">
                                    <h3>
                                        <span class="rctitle" style="font-size:16px;">zzh</span>
                                    </h3>
                                    <h5 style="color: #999;font-size: 13px;">
                                        <span>
                                            发布：<span class="rcusername">zzh</span>
                                            类型：<span class="rctype">日程提醒</span>
                                        </span>
                                        <span style="float:right;">
                                            <span class="rcstarttime">2020-10-20 20:44</span> 至
                                            <span class="rcendtime">2021-10-20 21:44</span>
                                        </span>
                                    </h5>
                                </div>
