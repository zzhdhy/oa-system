...
<div class="col-md-12 see">
                ...
                <div class=" mailbox-read-info">
                    ...
                    <h5 class="fonts">
						<span id="ctl00_cphMain_lblFrom" class="mailbox-read-time">发送：<i>${pushname}</i>
							&nbsp;&nbsp;接收：<i>${(mail.inReceiver)!''}</i>
						</span>
                        <span id="ctl00_cphMain_lblDate" class="mailbox-read-time pull-right">
							${mail.mailCreateTime}
						</span>
                    </h5>
                </div>
    ...
    <div class="box-footer foots">
        <a class="btn btn-default fault fa-back" href="javascript:history.back();">
