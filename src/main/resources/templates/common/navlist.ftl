<div class="col-md-12 green">
    ...
    <ul class="nav navbar-nav navbar-right moredeep">
        <#--导航栏显示日期-->
        <#-- <li>
             <a href="javascript:void(0);" class="green-none white">
                 <span id="dateTime1">1998年 08月10日 00:00:00 星期日</span>
             </a>
         </li>-->
        <li>
        ...
        <li style="position: relative;">
            ...
            <ul id="historypanel" class="dropdown-menu"
                style="position: absolute; background: #222d32;">
