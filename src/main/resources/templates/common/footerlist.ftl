...
<div class="col-md-12" id="ss"
     style="background-color: #DCD9D4;
 background-image: linear-gradient(to bottom, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%), radial-gradient(at 50% 0%, rgba(255,255,255,0.10) 0%, rgba(0,0,0,0.50) 50%);
 background-blend-mode: soft-light,screen;padding: 15px;position:absolute;bottom: 0;height:50px;">
    <strong> Copyright © By 2020-
        <script>document.write(new Date().getFullYear());</script>
        ,<a href="#">ZZH</a>.
    </strong> All rights reserved.
    <div class="pull-right currt-time" id="dateTime" style="display: inline-block;margin-right: 20px;">
        1998年 08月10日 00:00:00 星期日
    </div>
</div>
<#--    </div>
</div>-->
...
<script type="text/javascript">
    $(function () {
        ...
        /*获取当前时间并显示在底部栏  */
        /*  let day = new Date();
          this.minute = day.getMinutes() < 10 ? "0" + day.getMinutes() : day.getMinutes();
          this.second = day.getSeconds() < 10 ? "0" + day.getSeconds() : day.getSeconds();
          var week = ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"];
          this.hour = day.getHours() < 10 ? "0" + day.getHours() : day.getHours();
          var s = day.getFullYear() + "年";
