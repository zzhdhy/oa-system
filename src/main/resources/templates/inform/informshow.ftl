        ...
        <div class="bgc-w box box-primary"
            ...
            <div class="box-body no-padding chat-box">
                <div class="chat-title">
                    ...
                    <h5>
                        <small> <span>发布：${(userName)!''}</span>
                            <span class="pull-right">${(notice.noticeTime)!''}</span>
                        </small>
                    </h5>
                </div>
                <div class="chat-content" style="padding: 10px 40px 12px 16px;">
                    ...
                    <#if notice.url!=''>
                        <kbd><a href="${(notice.url)!''}" style="color: #fff;font-size:12px;">
                                <i class="glyphicon glyphicon-link"></i>打开连接</a></kbd>
                    <#else>
                    </#if>
                </div>
            </div>
