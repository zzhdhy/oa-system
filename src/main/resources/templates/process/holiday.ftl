...
<#list overtype as out>
    ${(out.typeColor)!''}
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                <input type="text" class="form-control inpu" readonly="readonly"
                                       style="background-color:#fff;" value="${username}"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                <input type="text" class="form-control inpu holistart" name="proId.startTime"/>
                            </td>
                            <td class="title"><label class="control-label">结束日期</label></td>
                            <td colspan="6">
                                <input type="text" class="form-control inpu holiend" name="proId.endTime"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="title"><label class="control-label">请假天数</label></td>
                            <td colspan="6">
                                <input type="text" class="form-control inpu days" name="leaveDays"
                                       readonly="readonly" style="background-color:#fff;"/>
                            </td>
                            <td class="title"><label class="control-label">审核人员</label></td>
                            <td colspan="6">
                                <input name="nameuser" type="text" id="recive_list" class="form-control "
                                       readonly="readonly" style="background-color:#fff;"/>
                                <div class="reciver">
