        ...
        <div class="bgc-w box box-solid " style="border-top: 3px solid blue;">
            <div class="box-header ">
				...
				<#if user.imgPath?? && user.imgPath!=''  >
                    <img style="width: 110px;height: 110px;" alt="头像"
                ...
                <ul class="list-group ">
                    <li class=""><b>我的消息</b> <a href="/infromlist" class="pull-right me"><span
                                    id="ctl00_cphMain_lblMsgCount">${noticelist}</span></a>
                    </li>
                    <hr class="pa"/>
                    <li class=""><b>我的邮件</b> <a href="mail" class="pull-right me"><span
                                    id="ctl00_cphMain_lblMailCount">${maillist}</span></a>
                    </li>
                    <hr class="pa"/>
                </ul>
                <#--这里可以将ediuser.ftl里面的内容添加到此页面data-target  id关联 -->
                <a href="##" class="btn btn-primary btn-block wri" data-toggle="modal" data-target="#notepaper"><b>
                        <i class="glyphicon glyphicon-pushpin"></i> 写便签</b></a>
            </div>
                    ...
                    <div class="tab-pane" id="settings">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="userName" type="text" value="${(user.userName)!''}"
                                           id="ctl00_cphMain_txtName" class="form-control  usernameonly"/>
                                    <input type="hidden" class="usernameonlyvalue" value=""/>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="eamil" type="text" value="${(user.eamil)!''}"
                                           id="ctl00_cphMain_txtEmail1" class="form-control"/>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="idCard" type="text" value="${user.idCard}"
                                           id="ic" class="form-control"/>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="themeSkin" id="ctl00_cphMain_ddlSkin" class="form-control select2">
                                        ...
                                        <option value="yellow">渐变黄</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="password1" type="password" id="Password1" class="form-control"/>
                                </div>
                        ...
                        <div class="box-footer" style="position: relative; overflow: hidden;">
                            ...
                            <input class="btn btn-default" id="cancel" type="button" value="取消"
                                   onclick="location.href='/userpanel'"/>
                        </div>
...
<script type="text/javascript">
    ...
    /*判断用户命是否已经存在*/
    $(".usernameonly").on("blur", function () {
        console.log("改变了！！~~");
        $.post("useronlyname", {"username": $(this).val()}, function (data) {
            console.log(data);
            $(".usernameonlyvalue").val(data);
        });
    });
    $(".usernameonly").focus(function () {
...
//	return false;
    ...
    function CheckBankNo(bankn) {
        ...
        /*取银行卡号前两位，若是在给出的strBin没有找到匹配的字符串则返回 -1*/
    ...
    function empcheck() {
        ...
        $('#settings .form-control').each(function (index) {
                ...
                if ($(this).val() == "") {
                    ...
                    if (index == 0) {
                        var isexist = $(".usernameonlyvalue").val();
                        /*  console.log("aaaa");
                          console.log(aaa);
                          console.log("aaaa");*/
                        if (isexist == "false") {
                            $(this).parent().addClass("has-error has-feedback");
                            alertCheck("用户名已存在,请重新输入!");
                            isRight = 0;
                            return false;
                        }
                    } else if (index == 1) {
