                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <#else>
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span>用户名</span></label>
                                    <input name="userName" class="form-control usernameonliy"
                                           value="${(user.userName)!''}"/>
                            ...
                            <#--<div class="col-md-6 form-group">
                                <label class="control-label"><span>入职时间</span></label>
                                <input id="hiretime" class="form-control"
                                       value="${(user.hireTime)?string('yyyy-MM-dd')!''}" onclick="WdatePicker();">
                            </div>-->
                            ...
                            <#else>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="hireTime" class="form-control" id="start"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="labels"><label>
                                            <input name="isbackpassword" type="checkbox">
                                            <i>✓</i></label>
                                    </span>
                                </div>
                            </div>
