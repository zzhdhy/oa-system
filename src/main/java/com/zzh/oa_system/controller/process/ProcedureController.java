package com.zzh.oa_system.controller.process;
...
import com.zzh.oa_system.model.dao.plandao.TrafficDao;
import com.zzh.oa_system.model.dao.processdao.*;
...
import com.zzh.oa_system.model.entity.process.*;
...
public class ProcedureController {
    ...
    public String holi(@RequestParam("filePath") MultipartFile filePath, HttpServletRequest req, @Valid Holiday eve, BindingResult br,
        ...
        if (roleid >= 3L && Objects.equals(fatherid, userid)) {
            ...
            if (eve.getTypeId() == 40) {
                /*type.getTypeSortValue() < eve.getLeaveDays()*/
                if (eve.getLeaveDays() > 10) {
                    model.addAttribute("error", "婚假必须小于10天。");
                    return "common/proce";
                }
            } else if (eve.getTypeId() == 38) {
                if (eve.getLeaveDays() > 4) {
