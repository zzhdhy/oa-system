package com.zzh.oa_system.controller.task;
...
import com.zzh.oa_system.model.dao.taskdao.TaskloggerDao;
...
import com.zzh.oa_system.service.task.TaskService;
...
//        String userId = ((String) session.getAttribute("userId")).trim();
    ...
    public String delete(HttpServletRequest req, @SessionAttribute("userId") Long userId) {
        ...
        if (task.getUsersId().getUserId().equals(userId)) {
            ...
            System.out.println(i + "mmmmmmmmmm");
