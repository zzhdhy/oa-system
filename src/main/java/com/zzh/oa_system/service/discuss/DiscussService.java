...
public class DiscussService {
    ...
    private Pageable setPageable(int page, String type, String time, String visitnum, List<Sort.Order> orders) {
        int size = 10;
        if (!StringUtils.isEmpty(type)) {
            ...
            if ("1".equals(visitnum)) {
                orders.add(new Sort.Order(Direction.DESC, "visitNum"));
            } else {
                orders.add(new Sort.Order(Direction.ASC, "visitNum"));
            }
        } else {
            orders.add(new Sort.Order(Direction.ASC, "typeId"));
            orders.add(new Sort.Order(Direction.DESC, "modifyTime"));
