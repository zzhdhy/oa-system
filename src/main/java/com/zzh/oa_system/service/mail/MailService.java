package com.zzh.oa_system.service.mail;

import com.github.pagehelper.util.StringUtil;
import com.zzh.oa_system.common.Base64Util;
...
public class MailService {
    ...
    public void pushmail(String account, String password, String reciver,
        ...
        // 收件人邮箱（替换为自己知道的有效邮箱）
        //  String receiveMailAccount = "860966177@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        if (!StringUtil.isEmpty(affix)) {
            ...
            messageBodyPart.setFileName("=?GBK?B?" + Base64Util.encode(filename) + "?=");
